...
import com.soywiz.korim.awt.awtConvertImage
...
class PlaySwing {
	fun combineColorMask(color: BufferedImage, mask: BufferedImage): BufferedImage {
		...
		val i_color = (awtConvertImage(color).raster.dataBuffer as DataBufferInt).data
		val i_mask = (awtConvertImage(mask).raster.dataBuffer as DataBufferInt).data
